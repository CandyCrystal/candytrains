    ...
    */
    ...
    var faces = {
        'sbb': {
            ...
            secondsRing: { r: outerRadius * 0, fill: 'white' },
            secondsInnermostRing: { r: outerRadius * 0, fill: 'black' },
            tickUnit: outerRadius * 0.0625 / 3,
            tickWidth: function(i) {
                return (i % 5) ? this.tickUnit * 2 : this.tickUnit * 3;
            },
            tickHeight: function(i) {
                return (i % 5) ? this.tickUnit * 3 : this.tickUnit * 3 * 4;
            },
            tickFill: function(i) {
                return '#fff';
            },
            ...
            clockHandHeight: function(d) {
                if (d.unit === "hours") {
                    ...
                    return (outerRadius - this.tickUnit * 3 * 3) * 1.4;
                }
            },
    ...
    vis = d3.select(config.target).append("svg:svg").attr("class", "clock").attr("style", "width:32vw; height:auto;position:absolute; left: 4vw;top:8vw").attr("viewBox", `0 0 ${width} ${width}`);
