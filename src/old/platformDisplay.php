...
<body class="display">
    ...
    <div class="trainDisplay" id="trainDisplay">
        <div id="trainDisplayTrain" class="trainDisplayTrain">
            <table class="trainDisplayTable" id="trainDisplayTable">
                <tr>
                    <td class="trainDisplayTableWagon wagonFront mediumOccupancy 27m" style="width: 22.25vw;">
                        <div class="frontLeftElement"></div>
                    </td>
                    <td class="trainDisplayTableWagon" style="width: 18vw;"></td>
                    <td class="trainDisplayTableWagon" style="width: 21.5vw;"></td>
                    <td class="trainDisplayTableWagon" style="width: 21.5vw;"></td>
                    <td class="trainDisplayTableWagon" style="width: 22.25vw;"></td>
                </tr>
            </table>
        </div>
...
<script>
    ...
    var platformLengthFormatted = platformLength / 100;
    platformLengthFormatted = 1
    console.log(platformLength + " " + platformLengthFormatted)
    ...
    function trainDisplay(departure) {
        ...
        var placement = (trainInfo.trainStopPoint / platformLengthFormatted) / 100
        console.log(placement + " " + platformLengthFormatted)

        // console.log("Direction and placement: " + direction + " " + placement)

        var train = "";
        if (direction == "FROM") {
            train += '<div id="trainElement"class="train'
        } else {
            train += '<div id="trainElement" class="train'
        }
        var trainLength = 0;
        ...
        if (departure.trainInfo.trainParts != undefined) {
            ...
            for (var i = 0; i < numTrainParts; i++) {
                ...
                if (thisWagon != undefined) {
                    for (var j = 0; j < thisWagon.length; j++) {
                        ...
                        var length = thisWagon[j].length / platformLengthFormatted;
                        ...
                        if (side == "left") {
                            train += '<div class="trainLeft '
                        } else {
                            train += '<div class="trainRight '
                        }
                        if (j == 0 && direction == "TO" && side == "left" || j == 0 && side == "right" && direction == "FROM") {
                            train += 'trainDisplayFrontLeft ' + wagonState + ' "></div><div style="width: ' + length + 'vw;" class="trainDisplayWagon ' + wagonState + ' middle ' + length + 'm">'
                        } else if (j == 0 && direction == "FROM" && side == "left" || side == "right" && j == 0 && direction == "TO") {
                            train += 'trainDisplayWagon backLeft ' + wagonState + " " + length + 'm" style="width: ' + length + 'vw;">'
                        } else if (j + 1 == thisWagon.length && direction == "TO" && side == "left" || j + 1 == thisWagon.length && direction == "FROM" && side == "left") {
                            train += 'trainDisplayWagon backRight ' + wagonState + " " + length + 'm" style="width: ' + length + 'vw;">'
                        } else if (j + 1 == thisWagon.length && direction == "FROM" && side == "left" || j + 1 == thisWagon.length && direction == "TO" && side == "left") {
                            train += 'trainDisplayWagon frontRight ' + wagonState + " " + length + 'm" style="width: ' + length + 'vw;">'
                        } else {
                            train += 'trainDisplayWagon middle ' + wagonState + " " + length + 'm" style="width: ' + length + 'vw;">'
                        }
            ...
            // document.getElementById("trainElement").style.width = 100 + "vw"

            if (hasSectors == 0) {
                document.getElementById("trainElement").style.right = (platformLengthFormatted / 2 - trainLength / 2) + "vw"
            } else if (direction == "FROM" && side == "left") {
                document.getElementById("trainElement").style.right = (platformLengthFormatted - placement) + "vw"
            } else if (direction == "TO" && side == "right") {
                document.getElementById("trainElement").style.right = placement + "vw"
            } else if (direction == "FROM" && side == "right") {
                document.getElementById("trainElement").style.left = (platformLengthFormatted - placement) + "vw"
            } else {
                document.getElementById("trainElement").style.left = placement + "vw"
            }
        }
    }
